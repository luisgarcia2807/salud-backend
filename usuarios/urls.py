...
urlpatterns = [
    ...
    path('api/centro/estadisticas/', estadisticas_centro_medico, name='estadisticas-centro'),
    path('api/pacientes/sin-consulta/', pacientes_sin_consulta_reciente),
    path('api/pacientes/', ListaPacientes1View.as_view(), name='lista_pacientes'),
